      ...
      <div className="container">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-20">
          {portfolioProjects.map((project) => (
            ...
            relative after:content-[''] after:absolute after:inset-0 z-0 after:z-10 overflow-hidden
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                ...
                text-transparent bg-clip-text"
                  ...
                  <a href={project.link} className="">
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-4 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
